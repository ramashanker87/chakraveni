## Command to create cloudformation
    ...
    --stack-name chakraveni-ec2-stack \
    --template-body file://chakraveni-ec2-template.yaml \
...
## Delete cloudformation command
   ...
   ## Command to create cloudformation for EC2 Web Server
    ...
    aws cloudformation create-stack \
    --stack-name chakraveni-ec2-web-stack \
    --template-body file://ec2-web-server-template.yaml \
    --parameters \
      ParameterKey=KeyName,ParameterValue=chakraveni-ec2 \
    --capabilities CAPABILITY_NAMED_IAM \
    --profile devops
...
## Command to create cloudformation for S3 Bucket
    ...
    aws cloudformation create-stack \
    --stack-name chakraveni-s3-stack \
    --template-body file://chakraveni-s3-template.yaml \
    --capabilities CAPABILITY_NAMED_IAM \
    --profile devops
